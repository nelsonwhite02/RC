...
month = st.slider("Performance By Months", min_value=1, max_value=12,
...
with col1:
    if month == 1:
        ...
        get_data = df.loc[df["RCs"] == selected_Rc][["Jan", "Feb", "Mar", "Apr", "May", "Jun", "July"]].squeeze()
        dt = pd.DataFrame(dict(
        ...
        get_data = df.loc[df["RCs"] == selected_Rc][["Jan", "Feb", "Mar", "Apr", "May", "Jun", "July", "Aug"]].squeeze()
        dt = pd.DataFrame(dict(
        ...
        get_data = df.loc[df["RCs"] == selected_Rc][["Jan", "Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Sept"]].squeeze()
        dt = pd.DataFrame(dict(
        ...
        get_data = df.loc[df["RCs"] == selected_Rc][["Jan", "Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Sept", "Oct"]].squeeze()
        dt = pd.DataFrame(dict(
        ...
        get_data = df.loc[df["RCs"] == selected_Rc][["Jan", "Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Sept", "Oct", "Nov"]].squeeze()
        dt = pd.DataFrame(dict(
        ...
        get_data = df.loc[df["RCs"] == selected_Rc][["Jan", "Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Sept", "Oct", "Nov", "Dec"]].squeeze()
        dt = pd.DataFrame(dict(
...
with col2:
   ...
   st.subheader(f"Total sales for {selected_Rc} in 12 months")
   get_data = df.loc[df["RCs"] == selected_Rc].eval('Sum = Jan + Feb + Mar + Apr + May + Jun + July + Aug + Sept + Oct + Nov + Dec')["Sum"].squeeze()
   ...
   if performing_RC == "Top 5 Performing RC":
         ...
         sum_data = df.eval('Sum = Jan + Feb + Mar + Apr + May + Jun + July + Aug + Sept + Oct + Nov + Dec')
